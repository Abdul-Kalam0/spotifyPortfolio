...
const callback = async (req, res) => {
  ...
  try {
    ...
    res.status(200).send(
     ...
     <h4>GET: https://abdul-portfolio-backend-eac01.vercel.app/spotify/top-tracks </h4>
     <h4>GET: https://abdul-portfolio-backend-eac01.vercel.app/spotify/currently-playing</h4>
     <h4>POST: https://abdul-portfolio-backend-eac01.vercel.app/spotify/play-track/uri</h4>
     <h4>GET: https://abdul-portfolio-backend-eac01.vercel.app/spotify/pause-current-song </h4>``<h4>GET: https://abdul-portfolio-backend-eac01.vercel.app/spotify/artists </h4>`
    );
  } catch (error) {
    res
      .status(500)
